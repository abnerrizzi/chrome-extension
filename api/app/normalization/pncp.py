...
def normalize(items: list[dict]) -> list[dict]:
    ...
    for it in items:
        ...
        res.append({
            ...
            "pncp_id": (it.get("pncp_id") or "").strip() or None,
            "numero_edital": (it.get("numero_edital") or "").strip() or None,
            "modalidade": (it.get("modalidade") or "").strip() or None,
            "municipio": municipio or None,
            "uf": uf or None,
            "objeto": (it.get("objeto") or "").strip() or None,
...
def normalize_detail(items: list[dict]) -> list[dict]:
    ...
    for it in items:
        ...
        res.append({
            ...
            "numero_edital": (it.get("numero_edital") or "").strip() or None,
            "modalidade": (it.get("modalidade") or "").strip() or None,
            "modo_disputa": (it.get("modo_disputa") or "").strip() or None,
            "orgao_cnpj": (it.get("orgao_cnpj") or "").strip() or None,
            "orgao_razao_social": (it.get("orgao_razao_social") or "").strip() or None,
            "municipio": municipio or None,
            "uf": uf or None,
            "objeto": (it.get("objeto") or "").strip() or None,
            ...
            "situacao": (it.get("situacao") or "").strip() or None,
            "srp": it.get("srp") is True,
            "amparo_legal": (it.get("amparo_legal") or "").strip() or None,
            ...
            "link_sistema_origem": (it.get("link_sistema_origem") or "").strip() or None,
            "url": (it.get("url") or "").strip(),
